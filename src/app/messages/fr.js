...
export const frComponentMessages = {
  ...
  "kendo.scheduler.deleteRecurringConfirmation":
    "Voulez-vous supprimer seulement cette occurrence ou toute la série ?",
  ...
  "kendo.scheduler.editorEventSeparateTimeZones":
    "Utiliser une Zone Horaire de début et de fin différente",
  ...
  "kendo.scheduler.editRecurringDialogTitle":
    "Modification de l'élément courant",
