...
const createFormGroup = (dataItem: any) =>
  new FormGroup({
    ...
    alcohol_permission: new FormControl(
      dataItem.alcohol_permission,
      Validators.required
    ),
    MC_DOT_required: new FormControl(
      dataItem.MC_DOT_required,
      Validators.required
    ),
  });
...
export class StatesComponent {
  ...
  public getStates(): void {
    ...
    this.httpService.fetchStates(payload).subscribe((data: any) => {
      this.states = data;
      this.gridView = [...data.items];
      this.loading = false;
    });
